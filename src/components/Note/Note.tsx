...
const Note: React.FC<NoteProps> = ({ title, content, color, tags, createdTime, id, isPinned }) => {
        ...
        <div className="note" style={noteStyle}>
            ...
            <div className="options">
                ...
                <button onClick={handleDelete} className="note-button">
                    <RiDeleteBin6Line style={{ fontSize: '18px', margin: '0', padding: '0' }} />
                </button>
                <button onClick={handleArchive} className="note-button">
                    <PiArchiveBoxBold style={{ fontSize: '18px', margin: '0', padding: '0' }} />
                </button>
            </div>
        </div>
    );
